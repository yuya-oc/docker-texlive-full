...
RUN /tmp/install-tl-unx/install-tl -profile /tmp/install-tl-unx/profile -repository http://ftp.math.utah.edu/pub/tex/historic/systems/texlive/2018/tlnet-final
