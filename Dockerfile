...
RUN wget -q http://ftp.math.utah.edu/pub/tex/historic/systems/texlive/2019/tlnet-final/install-tl-unx.tar.gz -O /tmp/install-tl-unx.tar.gz
...
RUN /tmp/install-tl-unx/install-tl -profile /tmp/install-tl-unx/profile -repository http://ftp.math.utah.edu/pub/tex/historic/systems/texlive/2019/tlnet-final
